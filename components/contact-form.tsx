          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="px-4 py-3 bg-primary-foreground/10 border border-primary-foreground/20 rounded-lg text-muted-foreground placeholder-primary-foreground/60 focus:outline-none focus:border-accent"
              />
            </div>
